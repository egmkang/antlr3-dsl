#ifndef __AS_GENERATOR_H__
#define __AS_GENERATOR_H__
...
class AsGenerator : public Generator
{
  public:
    AsGenerator(const std::string& path, const std::string& file_name, const std::string& out_path);
